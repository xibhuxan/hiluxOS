    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/btmedia',
            pageBuilder: (_, state) => _fadeSlidePage(key: state.pageKey, child: const BtMediaScreen()),
          ),
          GoRoute(
            path: '/weather',
            pageBuilder: (_, state) => _fadeSlidePage(key: state.pageKey, child: const WeatherScreen()),
          ),
          GoRoute(
            path: '/maps',
